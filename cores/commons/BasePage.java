...
public class BasePage {
	...
	/**
	 * To open a page by using a provided url
	 *
	 * @param driver
	 * @param pageUrl
	 */
	...
	/**
	 * Get text from the FIRST SELECTED item in drop down list by using FIXED LOCATOR
	 *
	 * @param driver
	 * @param locator
	 * @return
	...
	/**
	 * Get text from the FIRST SELECTED item in drop down list by using locator REST PARAMETER values
	 *
	 * @param driver
	 * @param locator
	 * @param castValue
