...
public class Level_22_Manage_Data_Faker_Browserstack extends BaseTest {
	WebDriver driver;
	...
	@BeforeClass
	public void beforeClass(String browserName, String url, String osName, String osVersion) {
		driver = getBrowserDriverBrowserstack(browserName, url, osName, osVersion);
