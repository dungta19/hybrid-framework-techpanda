...
//				"Login_01 - Step 1: Input an empty value to email address textbox ");
//		loginPage.inputToEmailAddressTextbox("");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_01 - Step 2: Input an empty value to password textbox ");
//		loginPage.inputToPasswordTextbox("");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_01 - Step 3: Click to login button ");
...
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
//				"Login_02 - Step 1: Input an invalid email address '" + invalidEmail + "'");
//		loginPage.inputToEmailAddressTextbox(invalidEmail);
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_02 - Step 2: Input a valid password");
//		loginPage.inputToPasswordTextbox("123456");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_02 - Step 3: Click to login button");
//		loginPage.clickToLoginButton();
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
...
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
//				"Login_03 - Step 1: Input a never registered email address '" + incorrectEmail + "'");
//		loginPage.inputToEmailAddressTextbox(incorrectEmail);
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_03 - Step 2: Input a valid password");
//		loginPage.inputToPasswordTextbox("123456");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_03 - Step 3: Click to login button");
//		loginPage.clickToLoginButton();
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
...
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
//				"Login_04 - Step 1: Input a never registered email address '" + incorrectEmail + "'");
//		loginPage.inputToEmailAddressTextbox(incorrectEmail);
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_04 - Step 2: Input a password less than 6 characters");
//		loginPage.inputToPasswordTextbox("123");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_04 - Step 3: Click to login button");
//		loginPage.clickToLoginButton();
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
...
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
//				"Login_05 - Step 1: Input a never registered email address '" + incorrectEmail + "'");
//		loginPage.inputToEmailAddressTextbox(incorrectEmail);
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
//				"Login_05 - Step 2: Input a well-formated password but it was never used before '" + randomPassword
//						+ "'");
//		loginPage.inputToPasswordTextbox(randomPassword);
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_05 - Step 3: Click to login button");
//		loginPage.clickToLoginButton();
//
//		ExtentTestManager.getTest().log(LogStatus.INFO,
...
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_06 - Step 1: Input a valid email address");
//		loginPage.inputToEmailAddressTextbox("automationfullstack@gmail.net");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_06 - Step 2: Input a valid password");
//		loginPage.inputToPasswordTextbox("123456789");
//
//		ExtentTestManager.getTest().log(LogStatus.INFO, "Login_06 - Step 3: Click to login button");
