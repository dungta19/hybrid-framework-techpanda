...
public class Level_18_Pattern_Objects extends BaseTest {
    WebDriver driver;
...
//        loginPage.inputToPasswordTextbox("");
    ...
    public void Login_02_Invalid_Email() {
        ...
        Assert.assertEquals(loginPage.getValidationAdviceMessageByLabelName(driver, "Email Address"),
    ...
    public void Login_04_Invalid_Password() {
        ...
        Assert.assertEquals(loginPage.getValidationAdviceMessageByLabelName(driver, "Password"),
